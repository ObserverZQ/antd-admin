...
module.exports = {
  ...
  [`GET ${apiPrefix}/authenticateHistoryList`] (req, res) {
    const { query } = req
  ...
  [`DELETE ${apiPrefix}/authenticateHistoryList`] (req, res) {
    const { ids } = req.body
  ...
  [`POST ${apiPrefix}/authenticateHistory`] (req, res) {
  ...
  [`GET ${apiPrefix}/authenticateHistory/:id`] (req, res) {
    const { id } = req.params
  ...
  [`DELETE ${apiPrefix}/authenticateHistory/:id`] (req, res) {
    const { id } = req.params
    const data = queryArray(database1, id, 'id')
    if (data) {
  ...
  [`PATCH ${apiPrefix}/authenticateHistory/:id`] (req, res) {
    const { id } = req.params
